...
td <-td %>% # pass td to next function
     unite("Age_Sex", c(Age.Group, Sex), sep= "_", remove = FALSE) # using the unite() function from the tidyr package, if remove=TRUE the original Age.Group and Sex columns will be deleted
