...
For example, lets find the mean year of birth in our data.[^5]  We already know that when the pre-vowel contexts are removed, the mean year of birth is 1969.

[^5]: If you don't have the `td` dataset loaded in *R*, go back to the Interim Summary and run the code.
